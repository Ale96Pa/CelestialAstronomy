...
<p align="right">
    <img src="Image/logo.JPG" width="150" height="120" border="2" align="right"><h2><I> Search the stars included in a filament </I></h2>
<br><br><br><br><hr>
    ...
    <%} else {
        ...
        <table border="2">
            ...
            %><tr>
                ...
                <td><% out.print(star.getLongitude()); %></td>
                <td><% out.print(star.getLatitude()); %></td>
            </tr>
            <%}%>
        </table>
        <%}
